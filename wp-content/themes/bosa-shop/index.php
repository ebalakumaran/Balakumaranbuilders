							...
							<?php
								if( !get_theme_mod( 'disable_pagination', false ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'bosa-shop' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-shop' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-shop' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-shop' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-shop' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
