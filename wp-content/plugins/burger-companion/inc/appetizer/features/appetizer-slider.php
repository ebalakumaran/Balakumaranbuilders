...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	//Pro feature
		class Appetizer_slider_section_upgrade extends WP_Customize_Control {
			...
			?>
				<a class="customizer_Appetizer_slider_upgrade_section up-to-pro" href="#" target="_blank" style="display: none;"><?php _e('More Slides Available in Appetizer Pro','appetizer'); ?></a>
