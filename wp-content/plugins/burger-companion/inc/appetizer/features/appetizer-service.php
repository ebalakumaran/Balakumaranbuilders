...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	if ( class_exists( 'Burger_Companion_Repeater' ) ) {
		...
		class Appetizer_service_section_upgrade extends WP_Customize_Control {
			...
			?>
				<a class="customizer_Appetizer_service_upgrade_section up-to-pro" href="#" target="_blank" style="display: none;"><?php _e('More Services Available in Appetizer Pro','appetizer'); ?></a>
