...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	if ( class_exists( 'Burger_Companion_Repeater' ) ) {
		...
		class Appetizer_information_section_upgrade extends WP_Customize_Control {
			...
			?>
				<a class="customizer_Appetizer_information_upgrade_section up-to-pro" href="#" target="_blank" style="display: none;"><?php _e('More Information Available in Appetizer Pro','appetizer'); ?></a>
