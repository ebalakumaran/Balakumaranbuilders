...
if ( ! function_exists( 'bosa_shop_enqueue_styles' ) ) :
	/**
	 * @since Bosa Shop 1.0.0
	 */
	function bosa_shop_enqueue_styles() {
		wp_enqueue_style( 'bosa-shop-style-parent', get_template_directory_uri() . '/style.css',
			array(
				'bootstrap',
				'slick',
				'slicknav',
		...
		wp_enqueue_style( 'bosa-shop-google-fonts', "https://fonts.googleapis.com/css2?family=Jost:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap", false );
		wp_enqueue_style( 'bosa-shop-google-fonts-two', "https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap", false );
	}

endif;
add_action( 'wp_enqueue_scripts', 'bosa_shop_enqueue_styles', 1 );

/**
* Add cart link
* @since Bosa Shop 1.0.0
*/
if ( !function_exists( 'bosa_shop_cart_link' ) ) {
    function bosa_shop_cart_link() {
        ?>	
...
* @since Bosa Shop 1.0.0
*/
if ( !function_exists( 'bosa_shop_header_cart' ) ) {
    function bosa_shop_header_cart() {
        ?>
            <div class="header-cart">
                <div class="header-cart-block">
                    <div class="header-cart-inner">
                        <?php bosa_shop_cart_link(); ?>
...
* @since Bosa Shop 1.0.0
*/
if ( !function_exists( 'bosa_shop_header_add_to_cart_fragment' ) ) {
    function bosa_shop_header_add_to_cart_fragment( $fragments ) {
        ob_start();
        bosa_shop_cart_link();
        $fragments['a.cart-icon'] = ob_get_clean();
        return $fragments;
    }
    add_filter( 'woocommerce_add_to_cart_fragments', 'bosa_shop_header_add_to_cart_fragment' );
}
...
* @since Bosa Shop 1.0.0
*/
if ( !function_exists( 'bosa_shop_head_wishlist' ) ) {
    function bosa_shop_head_wishlist() {
            ...
            <div class="header-wishlist">
                <a href="<?php echo esc_url( $wishlist_url ); ?>">
                    ...
                    <span class="info-tooltip">
                        <?php esc_html_e( 'Wishlist', 'bosa-shop' ); ?>
                    </span>
                </a>
            </div>
            <?php
...
* @since Bosa Shop 1.0.0
*/
if (!function_exists( 'bosa_shop_head_compare' ) ) {
    function bosa_shop_head_compare() {
        if ( function_exists( 'yith_woocompare_constructor' ) ) {
            ...
            <div class="header-compare">
                <a class="compare added" rel="nofollow" href="<?php echo esc_url( $yith_woocompare->obj->view_table_url() ); ?>">
                    ...
                    <span class="info-tooltip">
                        <?php esc_html_e( 'Compare', 'bosa-shop' ); ?>
                    </span>
                </a>
            </div>
            <?php
...
* @since Bosa Shop 1.0.0
*/
if ( !function_exists( 'bosa_shop_my_account' ) ) {
    function bosa_shop_my_account() {
            ...
            <div class="header-my-account">
                <div class="header-login"> 
                    <a href="<?php echo esc_url( get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ) ); ?>">
                        ...
                        <span class="info-tooltip">
                            <?php esc_html_e( 'My Account', 'bosa-shop' ); ?>
                        </span>
                    </a>
                </div>
            </div>
...
function bosa_header_advertisement_banner(){
    ...
    $header_advertisement_banner_obj = wp_get_attachment_image_src( $bannerImageID, 'bosa-555-68' );
    ...
    ?>
        <div class="header-advertisement-banner">
            <a href="<?php echo esc_url( get_theme_mod( 'header_advertisement_banner_link', '#' ) ); ?>" alt="<?php echo $alt; ?>" target="_blank">
...
* 
* @since Bosa Shop 1.0.1
* @return array.
*/
function bosa_store_get_pages(){
