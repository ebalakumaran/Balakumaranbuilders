	 ...
	 */
	 ...
	 //Pro feature
		class Appetizer_social_section_upgrade extends WP_Customize_Control {
			...
			?>	
				<a class="customizer_Appetizer_social_upgrade_section up-to-pro" href="#" target="_blank" style="display: none;"><?php _e('More Icons Available in Appetizer Pro','appetizer'); ?></a>
