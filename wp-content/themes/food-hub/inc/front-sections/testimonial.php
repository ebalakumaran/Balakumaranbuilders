...
if ( ! function_exists( 'food_hub_add_testimonial_section' ) ) :
 
    function food_hub_add_testimonial_section() {
...
if ( ! function_exists( 'food_restro_render_testimonial_section' ) ) :
   ...
   function food_restro_render_testimonial_section( $content_details = array() ) {
        ...
        <div id="food_restro_testimonial_section">

        <div id="client-testimonial" class="relative page-section">
                <div class="wrapper">
                        <div class="section-header">
                         <?php if ( ! empty( get_theme_mod( 'testimonial_sub_title' ) ) ) : ?>
                        <p class="section-subtitle"><?php echo esc_html( get_theme_mod( 'testimonial_sub_title' ) ); ?></p>
                    <?php endif;

                    if ( ! empty( $options['testimonial_title'] ) ) : ?>
