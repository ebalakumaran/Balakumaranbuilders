	...
	<section class="section-feature-posts-area feature-posts-layout-one">
		...
		<div class="content-wrap">
			...
			<?php
				...
				$image = get_the_post_thumbnail_url( get_the_ID(), 'bosa-420-300' );

				$columns_class = '';
				if( get_theme_mod( 'feature_posts_columns', 'four_columns' ) == 'one_column' ){
					$columns_class = 'col-md-12';
				}elseif( get_theme_mod( 'feature_posts_columns', 'four_columns' ) == 'two_columns' ){
					$columns_class = 'col-md-6';
				}elseif( get_theme_mod( 'feature_posts_columns', 'four_columns' ) == 'three_columns' ){
					$columns_class = 'col-md-4';
				}elseif( get_theme_mod( 'feature_posts_columns', 'four_columns' ) == 'four_columns' ){
