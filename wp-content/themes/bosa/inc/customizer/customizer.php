...
function bosa_customize_register( $wp_customize ) {
	...
	if ( class_exists( 'WooCommerce') ) {
		$wp_customize->get_control( 'woocommerce_shop_page_display' )->priority  = '20';
		$wp_customize->get_control( 'woocommerce_category_archive_display' )->priority  = '30';
		$wp_customize->get_control( 'woocommerce_default_catalog_orderby' )->priority  = '40';
	}
}
add_action( 'customize_register', 'bosa_customize_register', 15 );
...
function bosa_kirki_fields(){
	...
	*/
	...
	Kirki::add_field( 'bosa', array(
		'label'			=> esc_html__( 'Add To Cart Button', 'bosa' ),
		'type'			=> 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Single Product Title', 'bosa' ),
		'type'         => 'checkbox',
